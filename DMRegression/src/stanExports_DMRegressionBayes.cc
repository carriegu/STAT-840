...
#include "stanExports_DMRegressionBayes.h"

RCPP_MODULE(stan_fit4DMRegressionBayes_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_DMRegressionBayes")
